    ...
    def initialise(cls):
        if not cls._initialised:
            ...
            try:
                ...
                cls.APP_NAME = config_reader.read_config_value("APP_NAME")
                cls.URI = config_reader.read_config_value("MONGODB_URI")
                cls.db_name = config_reader.read_config_value("db_name")
                cls.collection_name = config_reader.read_config_value("collection_name")
                cls.rtsp_url = config_reader.read_config_value("rtsp_url")
